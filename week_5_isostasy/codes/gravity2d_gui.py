...
#    CustomWidgets (and its transitive deps) can be imported
...
from talwani_model import compute_gz
from data_loader import load_csv_data, ObservedData
from model_io import save_model, load_model, apply_model
...
class InversionDock(QDockWidget):
    ...
    def _on_run(self):
        from gravity_inversion import InversionConfig
        cfg = InversionConfig(
...
class MainWindow(QMainWindow):
    ...
    def _run_inversion(self, cfg):
        from gravity_inversion import InversionWorker
