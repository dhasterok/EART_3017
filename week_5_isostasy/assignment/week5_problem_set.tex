...
\begin{enumerate}
    ...
    \item determine the difference in density contrast between oceanic and continental lithosphere to account for the difference in elevation, and
...
% Now assume the crust initially consists of:
% \begin{itemize}
