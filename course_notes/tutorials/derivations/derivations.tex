...
\begin{equation}
    ...
    \label{eq-height}
\end{equation}
Next, we can substitute Equation \ref{eq-height} into the modified pressure Equation \ref{eq-column2}.  And after some algebra, we arrive at a solution for
the root,
\begin{align*}
