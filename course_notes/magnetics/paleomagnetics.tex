...
Paleomagnetism is the study of the magnetic record preserved in rocks, sediments, and archaeological materials. It provides fundamental constraints on plate tectonics, geomagnetic field behavior, and the evolution of Earth's interior. Magnetic signals are recorded as natural remanent magnetization (NRM), which reflects both the geomagnetic field and subsequent geological processes.
...
Magnetic behavior arises from electron spin and orbital angular momentum.  There are three dominant types of magnetization including diamagnetism, paramagnetism, and ferromagnetism. 
\begin{description}
...
\item \textbf{Pseudo-single-domain (PSD)}: intermediate behavior
...
\subsection{Types of magnetic behavior}

Magnetic behavior arises from the alignment of atomic magnetic moments. Materials are classified as:
\begin{itemize}
    \item diamagnetic,
    \item paramagnetic,
    \item ferromagnetic,
...
\begin{itemize}
    ...
    \item \textbf{Pseudo-single-domain (PSD)} grains: intermediate behavior.
...
Magnetic behavior is characterized by hysteresis loops:
\begin{itemize}
...
\section{Geomagnetic Field behavior}
