\chapter{Algebra \& Trigonometry}\label{apx:algebra}
...
be performed interchangeably.  If we then follow the order of operations
...
There are a number of useful trigonometric identities than can be used
