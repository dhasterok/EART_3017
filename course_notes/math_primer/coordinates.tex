...
\section{Integrals}
Suppose we wanted to take an integral along a path or about an area or volume but we wish to change coordinate systems to simplify the math.  In this case we have to change the infinitesimal.  In the case of a line integral,
\begin{equation*}
    \dd{\ell} = 
    \begin{cases}
