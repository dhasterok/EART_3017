...
\begin{quote}The power of equations lies in the philosophically difficult correspondence between mathematics, a collective creation of human minds, and an external physical reality.  Equations model deep patterns in the outside world.  By learning to value equations, and to read the stories they tell we can uncover vital features of the world around us.  In principle, there might be other ways to achieve the same result.  Many people prefer words to symbols; language, too, gives us power over our surroundings.  But the verdict of science and technology is that words are too imprecise, and too limited, to provide an effective route to deeper aspects of reality.  They are too colored by human-level assumptions.  Words alone can't provide the essential insights.
...
mathematics that you will need to understand this course to the fullest extent
...
need at uni (including statistics). They specialize in helping people improve
...
\begin{table}[hbt]
    ...
    \begin{tabular}{@{}ccl@{}}
        ...
        $d$ & infinitesimal & derivatives/integration \\
...
to mention hard to read.  Imagine having to count the number of zeros every
...
scientific notation}.  Beyond making large and small numbers easier to read, we
...
results from the sensitivity of an instrument or other measurement and
...
the number of digits between preceding and trailing zeros.
...
fictitious.  We can reasonably keep one estimated digit, but all others should
...
There are a couple rules for rounding (we'll use the simplest one).  Take the
last significant digit.  If it is $\geq$5, round the preceding digit up,
