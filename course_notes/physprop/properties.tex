...
\begin{enumerate}
    \item Gravity \& magnetics: Density appears explicitly in formulation of the gravitational potential.
...
% The properties of a rock are dependent upon the fraction of each constituent
