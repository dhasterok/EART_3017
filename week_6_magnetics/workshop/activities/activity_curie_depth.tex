...
This activity explores how temperature limits crustal magnetization and why deep magnetic structure is long-wavelength.

\section*{Learning Outcomes}

By the end of this activity, you should be able to:
\begin{itemize}
  \item Explain how the Curie temperature limits the depth of crustal magnetization.
...
\begin{questions}
  ...
  \begin{enumerate}
    \item What mineral dominates crustal magnetization?
    \answerbox[1.5cm]
  ...
  Assume:
  \[
    T_C = \SI{580}{^\circ C}, \quad k = \SI{2.8}{W.m^{-1}.K^{-1}}
  \]
  \[
    q = k\frac{T_s - T_C}{z}
  \]
...
\textbf{The Curie temperature defines the base of crustal magnetization.} Above this temperature (about \SI{580}{^\circ C} for magnetite), thermal energy prevents the alignment of magnetic domains and the rock is effectively non-magnetic. The depth at which crustal temperatures reach the Curie point therefore sets the maximum depth from which magnetic anomalies can originate.
...
\textbf{Magnetic and seismic Moho usually differ, and for a specific reason.} Because Curie depth tracks the geotherm rather than composition, a hot, thin crust (e.g., a rift zone) can reach $T_C$ within the crust, while a cold, thick craton can push $T_C$ down to, or below, the seismic Moho. Where the isotherm sits above the Moho, the mismatch is thermally controlled; where it would sit below the Moho, the mantle's low susceptibility takes over and the boundary becomes compositional instead. Magnetic crustal thickness is therefore not a direct proxy for seismic crustal thickness---which one controls it depends on tectonic setting.
