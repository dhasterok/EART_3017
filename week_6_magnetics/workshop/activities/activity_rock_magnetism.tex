...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{@{}|c|X|X|c|X|@{}}
        ...
        \midrule
        1\rule{0pt}{2em} & peridotite & & & \\
        \midrule
        2\rule{0pt}{2em} & serpentinite & & & \\
        \midrule
        3\rule{0pt}{2em} & basalt (fresh) & & & \\
        \midrule
        4\rule{0pt}{2em} & basalt (altered) & & & \\
        \midrule
        5\rule{0pt}{2em} & eclogite & & & \\
        \bottomrule
    \end{tabularx}
...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{@{}|c|X|X|c|X|@{}}
        ...
        \midrule
        6\rule{0pt}{2em} & gabbro & & & \\
        \midrule
        7\rule{0pt}{2em} & diorite & & & \\
        \midrule
        8\rule{0pt}{2em} & granodiorite & & & \\
        \midrule
        9\rule{0pt}{2em} & granite 1 & & & \\
        \midrule
        10\rule{0pt}{2em} & granite 2 & & & \\
        \bottomrule
    \end{tabularx}
\end{table}
...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{@{}|c|X|X|c|X|@{}}
        ...
        \midrule
        11\rule{0pt}{2em} & magnetite & & & \\
        \midrule
        12\rule{0pt}{2em} & galena & & & \\
        \midrule
        13\rule{0pt}{2em} & tin ore & & & \\
        \bottomrule
    \end{tabularx}
\end{table}
