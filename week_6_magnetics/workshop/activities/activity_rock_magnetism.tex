...
\textbf{Magnetite controls crustal magnetization.} Even small amounts of magnetite (a few percent by volume) dominate the magnetic susceptibility of a rock because its susceptibility is orders of magnitude higher than that of silicate minerals. Susceptibility is therefore highly sensitive to trace magnetite abundance, not bulk composition --- and, as the ore station shows, not to metal content in general either.

\textbf{Susceptibility depends on which Fe-Ti oxide is present, not how much iron the rock contains.} Serpentinization of olivine produces magnetite as a byproduct of hydration,
\[
...
\]
converting magnetite to hematite. Eclogitization removes magnetite by a different route again --- Fe and Ti are redistributed into garnet and omphacite as the rock recrystallizes under high pressure, rather than through a single hydration or oxidation reaction.
...
\textbf{Two very different histories can produce the same magnetic outcome.} The altered basalt and the eclogite both end up weakly magnetic despite sharing a basaltic protolith --- one lost its magnetite to near-surface oxidation, the other to deep metamorphic recrystallization. A low susceptibility measurement alone cannot distinguish which history a sample experienced, foreshadowing the non-uniqueness problem you will meet again in Activity 6.C.

\textbf{Igneous differentiation sets susceptibility before any alteration occurs.} Progressively more felsic melts crystallize progressively less Fe-Ti oxide, so susceptibility can vary systematically across an igneous suite purely as a primary crystallization effect, with no reaction or alteration involved at all.
