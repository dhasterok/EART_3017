...
\textbf{Two very different histories can produce the same magnetic outcome.} The altered basalt and the eclogite both end up weakly magnetic despite sharing a basaltic protolith --- one lost its magnetite to near-surface oxidation, the other to deep metamorphic recrystallization. A low susceptibility measurement alone cannot distinguish which history a sample experienced.
