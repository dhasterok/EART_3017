    ...
    postaction={
      ...
      decoration={
        ...
        mark=at position 0.75 with {
          \draw[<-,thin] (0,0) .. controls (0,-0.25) and (0.2,-0.25) .. (0.2,-1.0)
          \node[right] at (0.2,-1.0) {$\partial\Omega$};
        }
      }
  }
  ] \curve;
...
%\draw[<-,thin] (3.5,0.1) .. controls (3.8,0.1) and (3.8,0.5) .. (4.4,0.5) node[right] {$\partial\Omega$};

% normal
%\draw[->,thick]
%  let \p1 = ($ (Q) - (P) $), \n1 = {atan2(\y1,\x1)} in
%  (P) -- ++(\n1+90:0.5cm) node {$\vu{n}$};
