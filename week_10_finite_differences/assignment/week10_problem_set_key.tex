...
\item \textbf{Qualitative behavior}
...
\textbf{Key point:} Geometry, not material properties, drives the 2-D behavior.
...
\begin{itemize}
\item 1-D model provides smooth, averaged behavior
