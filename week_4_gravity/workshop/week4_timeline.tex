...
\begin{itemize}
  ...
  \item Recognize non-uniqueness and explain why lenticular shallow bodies can mimic deep spheres.
\end{itemize}
...
Discuss non-uniqueness: why can shallow, lens-shaped bodies (``lenticular'') mimic deep spheres?
