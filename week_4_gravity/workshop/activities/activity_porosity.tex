...
\textbf{Porosity and density are linked.}
Sedimentary rocks contain pore space that is commonly filled with fluids. As porosity decreases, the fraction of solid material increases and the bulk density moves closer to the density of the rock matrix.

\textbf{Compaction is most effective at shallow depths.}
Increasing overburden stress reduces pore space, but the rate of compaction decreases with depth as sediments become progressively denser and less compressible. Most porosity loss occurs in the upper crust.

\textbf{Density contrasts evolve during burial.}
Because compaction changes the density of sediments, the density contrast between sediments and crystalline basement changes through time. These changes influence the gravity field and affect how sedimentary basins are interpreted.
