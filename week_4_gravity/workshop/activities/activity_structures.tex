...
For each structure below, complete the table and use the \emph{upper axes} to sketch the expected gravity anomaly $g_z(x)$ (arbitrary units). The \emph{lower panel} shows a schematic cross-section ($z$ positive downward).\\
