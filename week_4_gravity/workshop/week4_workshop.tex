...
\title{Week 4 -- Workshop Plan\\Gravity: Density, Structures, and Non-Uniqueness}
...
\subsection*{0--10 min: Warm-up --- ``Why does density matter?''}
...
% ---------------------------------------------------------
\subsection*{10--45 min: Activity A --- Density of a Two-Component Porous Sandstone}
\textbf{Goal:} Build intuition for porosity, compaction, and fluid-substitution effects.
% links to week4_sandstone_activity
...
% ---------------------------------------------------------
\subsection*{45--75 min: Activity B --- Geologic Structures to Geologic Anomalies}
...
% ---------------------------------------------------------
\subsection*{75--105 min: Activity C --- Buried Sphere: Width--Depth and Non-Uniqueness}
...
\subsection*{105--135 min: Activity D --- Superposition: Build-an-Anomaly}
...
\subsection*{135--165 min: Activity E --- Match-Three: Cross-Sections \texorpdfstring{$\leftrightarrow$}{↔} Gravity Profiles}
...
% ---------------------------------------------------------
\subsection*{165--180 min: Wrap-up}
\begin{enumerate}
