...
To make things easier, we assume the initiating event is instantaneous.  This assumption is common when developing analytic transient solutions.  Next week we'll methods that we can use to incorporate more complex evolution.
