...
\begin{figure}[h]
    ...
    \caption{Half-space cooling at several times. Each curve reaches $T_s+0.84\,\Delta T$ (dashed line) at its own thermal length $\ell_T=2\sqrt{\kappa t}$ -- the same fractional temperature change, at a depth that grows with time.}
    \label{fig:halfspace}
\end{figure}
