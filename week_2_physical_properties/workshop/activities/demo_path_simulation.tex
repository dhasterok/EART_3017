...
\begin{itemize}
  \item Predict which geometry (random, series, parallel) will produce the fastest or slowest transit, and connect this to the arithmetic, geometric, and harmonic mixing laws.
...
\begin{table}[h]
    ...
    \begin{tabular}{llll}
        ...
        Layers $\perp$ flow      & series   & Harmonic (Reuss)   & $\bigl(f_A/k_A + f_B/k_B\bigr)^{-1}$ \\
...
\begin{tabularx}{\textwidth}{@{}|l|X|X|X|@{}}
    ...
    Random granular   & & & \\
    \midrule
    Layered $\perp$ flow (series)   & & & \\
    \midrule
    Layered $\parallel$ flow (parallel)  & & & \\
    \midrule
    Random granular   & & & \\
    \midrule
    Layered $\perp$ flow (series)   & & & \\
