...
Travel time through a domain of width $W$ is $t = W / k_\text{eff}$, so the geometry that maximizes $k_\text{eff}$ also minimizes $t$.
...
\begin{questions}
    ...
    \question{Realism}
        In what ways does this simulator capture real rock behavior?
        \answerbox[3cm]
