...
Much like our senses, different fields are sensitive to different things.  Are geophysical fields sensitive to individual minerals or bulk rock properties?  Are they sensitive to different scales?  What do they tell us?
...
\timeline[item]{Rock Fabric \& Mixing Laws}{25}
...
Each group tackles two scenarios ($\sim$20 min each: 12 min discussion, 5 min notes, 3 min question drafting). Use the dedicated scenario handouts. Outcomes must include: (i) property/mixing-law decisions and (ii) 2--3 \emph{questions to ask the geologist} before committing to a model/survey.

\timeline[demo]{Path Simulation}{35}
