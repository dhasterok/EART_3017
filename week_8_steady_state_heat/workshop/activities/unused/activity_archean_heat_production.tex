...
\begin{itemize}
  \item Explain qualitatively why radioactive decay alone fails to account for the low heat production observed in preserved Archean crust.
  \item Describe at least three geological processes (differentiation, erosion, reworking, foundering, secular cooling) that can reduce or redistribute heat-producing elements in the crust.
  \item Use simple mathematical models (exponential decay, mixing equations) to estimate the effect of each process on crustal heat production.
  \item Explain how crustal heat production controls geotherm curvature and why two terranes with the same surface heat flow can have very different deep temperatures.
\end{itemize}
}
