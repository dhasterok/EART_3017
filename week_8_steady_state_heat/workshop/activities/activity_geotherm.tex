...
\begin{figure}[h]
  ...
  \label{fig:layers}
\end{figure}
Assuming a layered Earth within which the properties thermal conductivity and heat production are constant (Figure~\ref{fig:layers}), we can write the above expressions as
\[
