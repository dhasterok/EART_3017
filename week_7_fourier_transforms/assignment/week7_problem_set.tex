...
\begin{itemize}
  ...
  \item Recognize the non-uniqueness inherent in potential-field interpretation
\end{itemize}
...
broad, regional anomalies or narrow, localized ones?
...
magnetization were both vertical.  The filter is:
\[
...
\begin{enumerate}[label=\alph*.]
  \item At what inclination do artifacts (ringing, extreme amplitudes) begin to
        appear?
...
\subsection*{Question 13 — Remanent magnetization}

The RTP filter assumes purely \emph{induced} magnetization parallel to the
ambient field.  How would remanent magnetization with a different direction affect
