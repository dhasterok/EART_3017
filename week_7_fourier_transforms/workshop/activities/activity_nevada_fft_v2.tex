...
At each stage, ask yourself the same question: \emph{does this result actually reflect the geology, or could it be an artefact of how the data were sampled and processed?}
...
\begin{questions}
    \question{Nevada Complete Bouguer Gravity}
        ...
        \begin{enumerate}[label=\roman*]
            ...
            \item Look for the shorter-wavelength ``stripes'' superimposed on that trend. Roughly how would you describe their scale compared to the overall map -- tens of kilometers, or hundreds?
            \answerbox[2cm]

            \item Thinking about aliasing, what would you need to know about this map's station spacing before trusting any wavelength you read off it by eye?
            \answerbox[2cm]
        \end{enumerate}
