...
\timeline[warmup]{Two Bumps, One Line}{10}
...
\timeline[item]{Fold Belt Survey}{35}

Sampling decisions set a hard limit on geological resolution.  In this example, you will explore the impact of aliasing.

\timeline[item]{Nevada Gravity: Filtering for Sediments}{50}

In this activity, you will explore the application of Fourier transforms to real world data, including
\begin{itemize}
  \item Complete Bouguer gravity of Nevada
  \item Spectral analysis: E--W/N--S power spectra and separating a real basin-scale signal from the red-noise background
  \item High-pass filtering and the geological assumption behind the pass/block wavelengths
  \item Parker--Oldenburg sediment thickness inversion
  \item Sanity-checking the result against known Nevada geology
\end{itemize}

\timeline[slot]{Break}{5}

\timeline[item]{Tower Hill Magnetics: Righting the Anomaly}{40}
Most filters are designed to restrict amplitudes by frequency.  In this activity, you will see how a filter can be designed to adjust phase.
\begin{itemize}
...
\subimport{activities/}{warmup_gravity}
