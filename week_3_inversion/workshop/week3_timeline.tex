...
\timeline[slot]{Buried Sphere --- Background}{10}
...
\timeline[slot]{Buried Sphere --- Jacobian Derivatives}{15}
\begin{enumerate}
...
\timeline[item]{Inversion of a Buried Sphere}{30}
...
\begin{description}
  ...
  \item [Non-uniqueness:] Demonstrate parameter trade-offs and resolution ellipses.
...
\subimport{activities/}{activity_testing_linearity}
