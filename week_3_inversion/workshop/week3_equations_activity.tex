...
\title{Week 3 -- Linear or Non-linear}
...
\begin{enumerate}[label=\arabic*.,itemsep=2pt]
  ...
  \item For each equation, identify the quantity or quantities that would be treated as the \emph{model parameter(s)} in an inversion.
